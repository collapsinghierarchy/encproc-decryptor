# encproc-decryptor (currently outdated and the functionality was moved to the survey creation / participation / results querying in the main encproc repo. This repository will be deleted soon.)
